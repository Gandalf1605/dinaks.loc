        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample05">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="doctors">Персонал</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row slider-text align-items-center">
                <div class="col-md-7 col-sm-12 element-animate">
                    ...
                    <p>Среди наших сотрудников есть специалисты с высшим медицинским образованием, профессиональные специалисты в области ремонта и обслуживания медтехники</p>
                </div>
            </div>
        </div>
